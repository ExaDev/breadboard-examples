import { board, base, asRuntimeKit, BoardRunner, code, OutputValues, InputValues } from "@google-labs/breadboard";
...
const algoliaBoardSearch = await board(() => {
    ...
    title: "Hackernews Angolia search",
...
export default algoliaBoardSearch
