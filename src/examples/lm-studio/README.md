...
query[/"input <br> id='query'"/]:::input -- "systemContext->systemContext" --> fn3["invoke <br> id='fn-3'"]
query[/"input <br> id='query'"/]:::input -- "userContext->userContext" --> fn3["invoke <br> id='fn-3'"]
query[/"input <br> id='query'"/]:::input -- "systemRole->systemRole" --> fn3["invoke <br> id='fn-3'"]
